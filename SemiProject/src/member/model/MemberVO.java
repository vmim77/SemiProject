...
public class MemberVO {
	...
	private String userid;             // 회원아이디
	   ...
	   public MemberVO(String userid, String pwd, String name, String email, String mobile, String postcode,
	         String address, String detailaddress, String extraaddress , String referral) {
	      this.userid = userid;
	      this.pwd = pwd;
	      this.name = name;
	      this.email = email;
	   ...
	   public MemberVO(String userid, String pwd, String name, String email, String mobile, String postcode,
	         String address, String detailaddress, String extraaddress, String gender, String birthday, String referral) {
	      this.userid = userid;
	      this.pwd = pwd;
	      this.name = name;
	      this.email = email;
