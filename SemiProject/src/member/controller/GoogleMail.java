...
public class GoogleMail {
   ...
   public void sendmail(String recipient, String certificationCode) throws Exception {
       ...
       prop.put("mail.smtp.user", "wotjdlee4176@gmail.com");
       ...
       // 제목 설정
       String subject = "localhost:9090/SemiProject/index.sh 회원님의 비밀번호를 찾기위한 인증코드 발송";
       msg.setSubject(subject);
               
       // 보내는 사람의 메일주소
       String sender = "ehdwns201@gmail.com";
   ...
   public void sendmail_OrderFinish(String recipient, String name, String emailContents) throws Exception {
      ...
      // 제목 설정
      String subject = " THIS MAN "+name+"님의 주문이 성공했습니다. ";
      msg.setSubject(subject);
              
      // 보내는 사람의 메일주소
      String sender = "wotjdlee4176@gmail.com";
      Address fromAddr = new InternetAddress(sender);
      msg.setFrom(fromAddr);
   ...
   }// end of sendmail_OrderFinish(String recipient, String certificationCode)-----------------
