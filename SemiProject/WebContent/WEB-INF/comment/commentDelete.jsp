...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("button#yesDelete").click(function(){ // 삭제를 눌렀다면
			...
			frm.action = "<%= ctxPath%>/comment/noticeCommentDelete.sh";
			frm.method = "post";
			frm.submit();
		});
...
<body>
	...
	<div class="container my-5 text-center">
		<h4>정말로 <span style="color:red;">${requestScope.commentno}</span>번 댓글을 삭제하시겠습니까?</h4>
	...
	<form name="goToDeleteFrm">
		<input type="hidden" name="commentno" value="${requestScope.commentno}">
	</form>
