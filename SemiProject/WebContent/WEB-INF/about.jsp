...
<jsp:include page="/WEB-INF/header.jsp" />
   ...
   <section class="ftco-section">
      <div class="container">
         <div class="row">
            ...
            <div class="col-lg-2 col-md-3 ">
               <div class="sort w-100 text-center ftco-animate">
                  <a href="<%= request.getContextPath()%>/productList.sh?productname=dubby">
            ...
            <div class="col-lg-2 col-md-3 ">
               <div class="sort w-100 text-center ftco-animate">
                  <a href="<%= request.getContextPath()%>/productList.sh?productname=mul">
            ...
            <div class="col-lg-2 col-md-3 ">
               <div class="sort w-100 text-center ftco-animate">
                  <a href="<%= request.getContextPath()%>/productList.sh?productname=boots">
            ...
            <div class="col-lg-2 col-md-3 ">
               <div class="sort w-100 text-center ftco-animate">
                  <a href="<%= request.getContextPath()%>/productList.sh?productname=loper">>
            ...
            <div class="col-lg-2 col-md-3 ">
               <div class="sort w-100 text-center ftco-animate">
                  <a href="<%= request.getContextPath()%>/productList.sh?productname=oxpode">
            ...
            <div class="col-lg-2 col-md-3 ">
               <div class="sort w-100 text-center ftco-animate">
                  <a href="<%= request.getContextPath()%>/productList.sh?productname=mongk">
         ...
         <%--     <div class="col-lg-2 col-md-3 ">
               <div class="sort w-100 text-center ftco-animate">
                  <a href="<%= request.getContextPath()%>/productList.sh?productname=sandle">
