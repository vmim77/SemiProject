...
<div id="container" style="width:1000px; height:1500px; margin-left:300px; font-family:맑은 고딕;">
	<table style="width:1000px; margin-top:50px;">
		...
		<tr style="border-top:solid 1px #d0d0e2;">
			...
			<td style="font-size:9pt; padding-left:10px; font-weight:bold;">
				<fmt:formatNumber value="${requestScope.sum_totalprice - coupon}" pattern="###,###" />원
			</td>
		</tr>
	...
	<table style="width:1000px; margin-top:30px;">
		...
		<!-- 여기부터 반복 -->
		<c:forEach var="ord" items="${requestScope.finalorderlist}" varStatus="status">
	...
	<table style="width:1000px; margin-top:50px;">
		...
		<tr style="border-top:solid 1px #d0d0e2; border-bottom:solid 1px #d0d0e2;">
			...
			<td style="font-size:9pt; padding-left:10px; border-bottom:solid 1px #d0d0e2; font-weight:bold;">
				${requestScope.text}
			</td>
		</tr>
	</table>
