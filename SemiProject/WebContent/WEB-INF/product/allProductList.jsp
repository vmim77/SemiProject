...
<style>
   ...
   .container .btntag6:hover {
        background-color: black;
        color: white;
   }
   
   .container .btntag7:hover {
        background-color: black;
        color: white;
   }
   
   .container .btntag8:hover {
        background-color: black;
        color: white;
   }
   
   .container .btntag9:hover {
        background-color: black;
        color: white;
   }
   
   .container .btntag10:hover {
        background-color: black;
        color: white;
   }
   
   .container .btntag11:hover {
        background-color: black;
        color: white;
   }
   
   .container .btntag12:hover {
        background-color: black;
        color: white;
   }
   
   .container .btntag13:hover {
        background-color: black;
        color: white;
   }
   
   .container .btntag14:hover {
        background-color: black;
        color: white;
   }
...
<script type="text/javascript">
   ...
   $("div.imgtag6").mouseover(function() {
        $(this).find("img#shose_6").attr("src",$("input#back_img6").val());
        $("button.btntag6").show();
   }).mouseout(function() {
        $(this).find("img#shose_6").attr("src", $("input#first_img6").val());
        $("button.btntag6").hide();
   });
   
   $("div.imgtag7").mouseover(function() {
        $(this).find("img#shose_7").attr("src",$("input#back_img7").val());
        $("button.btntag7").show();
   }).mouseout(function() {
        $(this).find("img#shose_7").attr("src", $("input#first_img7").val());
        $("button.btntag7").hide();
   });
   
   $("div.imgtag8").mouseover(function() {
        $(this).find("img#shose_8").attr("src",$("input#back_img8").val());
        $("button.btntag8").show();
   }).mouseout(function() {
        $(this).find("img#shose_8").attr("src", $("input#first_img8").val());
        $("button.btntag8").hide();
   });
   
   $("div.imgtag9").mouseover(function() {
        $(this).find("img#shose_9").attr("src",$("input#back_img9").val());
        $("button.btntag9").show();
   }).mouseout(function() {
        $(this).find("img#shose_9").attr("src", $("input#first_img9").val());
        $("button.btntag9").hide();
   });
   
   $("div.imgtag10").mouseover(function() {
        $(this).find("img#shose_10").attr("src",$("input#back_img10").val());
        $("button.btntag10").show();
   }).mouseout(function() {
        $(this).find("img#shose_10").attr("src", $("input#first_img10").val());
        $("button.btntag10").hide();
   });
   
   $("div.imgtag11").mouseover(function() {
        $(this).find("img#shose_11").attr("src",$("input#back_img11").val());
        $("button.btntag11").show();
   }).mouseout(function() {
        $(this).find("img#shose_11").attr("src", $("input#first_img11").val());
        $("button.btntag6").hide();
   });
   
   $("div.imgtag12").mouseover(function() {
        $(this).find("img#shose_12").attr("src",$("input#back_img12").val());
        $("button.btntag12").show();
   }).mouseout(function() {
        $(this).find("img#shose_12").attr("src", $("input#first_img12").val());
        $("button.btntag12").hide();
   });
   
   $("div.imgtag13").mouseover(function() {
        $(this).find("img#shose_13").attr("src",$("input#back_img13").val());
        $("button.btntag13").show();
   }).mouseout(function() {
        $(this).find("img#shose_13").attr("src", $("input#first_img13").val());
        $("button.btntag6").hide();
   });
   
   $("div.imgtag14").mouseover(function() {
        $(this).find("img#shose_14").attr("src",$("input#back_img14").val());
        $("button.btntag14").show();
   }).mouseout(function() {
        $(this).find("img#shose_14").attr("src", $("input#first_img14").val());
        $("button.btntag14").hide();
   });
   ...
   var btnVal0 = $("button.btntag0").val();
   var btnVal1 = $("button.btntag1").val();
   
   var first = $("input#first_img0").val()
   
   var html = "";
   
   $("button.btntag0").click(function(){
      console.log(btnVal0);
      console.log(first);
      console.log($("input#back_img0").val());
      console.log($("input#first_img0").val());
      console.log($("input#productname0").val());
      
      $("h5.tit").html($("button.btntag0").val());
   });
   
   $("button.btntag1").click(function(){
      console.log(btnVal0);
      console.log(first);
      console.log($("input#back_img0").val());
      console.log($("input#first_img0").val());
      ...
      $("h5.tit").html($("button.btntag1").val());
   });
...
<table style = "margin-bottom:50px;">
      <tr>
            <c:forEach var="productvo" items="${requestScope.allproductimgList}" varStatus="status">
   ...
   <table style = "margin-bottom:50px;">
         ...
         <tr>
            <c:forEach var="productvo" items="${requestScope.allproductimgList}" varStatus="status">
               <c:if test="${status.index > 11 && status.index < 15}">
                  <td>
                     <div class="container imgtag${status.index}" style="padding:0px">
                        <input type="hidden" id="first_img${status.index}" name="first_img${status.index}" value="${productvo.product_front_p1}"/>
                        <input type="hidden" id="back_img${status.index}" name="back_img${status.index}" value="${productvo.product_back_p2}"/>
   ...
   <div class="container quickviewmodal">   <!-- Modal 퀵 뷰 눌렀을때 나오는 모달 창 -->
      <div class="modal fade"  id="quick_view_modal">
        <div class="modal-dialog modal-lg" style= "max-width:65%; border-radius:0;">
          <div class="modal-content" style= "width:100%; border-radius:0;">
               <!-- Modal body -->
...
<div style="text-align:center; margin-top:50px; margin-bottom:50px;">
   <a href="<%= ctxPath%>/allProductList.sh" id="pagenum" style="color:gray; font-size:15pt; text-align:center; text-decoration:none; text-shadow: 0 0 100px;">1</a>
   <a href="<%= ctxPath%>/allProductList.sh" id="pagenum" style="color:gray; font-size:15pt; text-decoration:none; text-shadow: 0 0 50px;">2</a>
   <a href="<%= ctxPath%>/allProductList.sh" id="pagenum" style="color:gray; font-size:15pt; text-decoration:none; text-shadow: 0 0 50px;">3</a>
</div>
