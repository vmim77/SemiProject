...
<div style="text-align:center; margin-top:50px; margin-bottom:50px;">
	<a href="<%= ctxPath%>/allProductList.sh" id="pagenum" style="color:gray; font-size:15pt;">1</a>
	<a href="<%= ctxPath%>/allProductList2.sh" id="pagenum" style="color:gray; font-size:15pt;">2</a>
	<a href="<%= ctxPath%>/allProductList3.sh" id="pagenum" style="color:gray; font-size:15pt;">3</a>
</div>
