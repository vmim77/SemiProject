...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("button#searchadd").click(function(){
		...
		// 구매하기
		$("td#buynow").click(function(){
			
		});//end of $("td#buynow").click(function(){
	...
	<form>
		...
		<table style="width:1200px; margin-top:50px;">
			...
			<tr style="border-top:solid 1px #d0d0e2;">
				...
				<td>
					<div><input id="postcode" name="postcode" type="text" style="height:35px; width:75px; border:solid 1px #c0c0d8; margin-left:10px;"/><button id="searchadd" style="background-color:white; border:solid 1px #c0c0d8; margin-left:5px;"><span style="font-size:10pt;">우편번호</span><span style="color:red; font-size:10pt;">&nbsp;&gt;</span></button></div>
			...
			<tr style="border-top:solid 1px #d0d0e2; border-bottom:solid 1px #d0d0e2;">
				...
				<td>
					<textarea style="resize:none; height:100px; width:600px; border:solid 1px #c0c0d8; margin-left:10px;"></textarea>
				...
				<td style="width:300px;">
					<table style="width:1200px; height:240px; font-size:9.5pt; border:solid 1px #d0d0e2;">
						...
						<tr style="border:solid 1px #d0d0e2;">
							...
							<td id="buynow" style="height:40px; font-size:12pt; text-align:center; background-color:black; color:white; border:solid 1px black;">
								BUY NOW
							</td>
						</tr>
						<tr style="border:solid 1px #d0d0e2;">	
